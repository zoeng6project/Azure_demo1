<?php require ('./inc/header.php'); require_once('inc/database.php');?>
                ...
                <fieldset>
                    ...
                    <form id="order"  name="update_order" method="post" enctype="multipart/form-data">
                        <div>
                            ...
                            <input type="text" id="company_code" name="company_code" value="<?php echo "DEMO"; ?>" readonly style="background-color: #f2f2f2;">
                        </div>
                        <div>
